...
export default async function ManagerAnalyticsPage() {
  ...
  const staffMap = new Map<string, {
    userId: string; name: string; totalHours: number; premiumShifts: number; premiumHours: number; desiredHoursPerWeek: number | null; shiftCount: number;
  }>();
  ...
  return (
    <div>
      ...
      <p className="text-sm text-muted-foreground mb-5">Premium shift distribution and hours balance</p>
      <FairnessClient
        initialStaff={staff}
